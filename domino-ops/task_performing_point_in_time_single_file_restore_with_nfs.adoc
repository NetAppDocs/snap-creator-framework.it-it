...
NOTE: Se si esegue un ripristino da una copia SnapVault, viene richiesto di ripristinare dallo storage primario o secondario. La scelta dipende da come si gestisce la limitazione descritta in link:concept_domino_database_restore_overview.html["Concept_domino_database_restore_Overview.MD GUID-4D864E27-DE54-43BF-9B9F-EF2F240F65D9"].
