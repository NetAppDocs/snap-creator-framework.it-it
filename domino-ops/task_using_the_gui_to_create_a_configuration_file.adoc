...
. [[tredicesimo passaggio]]Nella pagina dei dettagli dello Snapshot, specificare le informazioni di configurazione dello Snapshot:
+
|===
| Per questo campo... | Eseguire questa operazione... 
...
.. Le istruzioni si trovano nel passaggio successivo<<thirteenth-step,13>>.
