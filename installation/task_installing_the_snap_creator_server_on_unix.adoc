...
Running
----
. Convalida l'avvio dell'interfaccia grafica di Snap Creator Framework accedendo all'host locale sulla porta specificata +(ad esempio,  https://10.12.123.123:8443)+[].
+
