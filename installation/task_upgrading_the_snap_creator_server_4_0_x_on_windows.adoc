...
Inoltre, è necessario convalidare l'avvio dell'interfaccia grafica di Snap Creator Framework accedendo all'host locale sulla porta specificata +(https://IP_address:gui_port)+[].
